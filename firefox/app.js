...
function setupEventListeners() {
  ...
  document.getElementById("imageToPdfTab").addEventListener("click", () => switchTab("imageToPdf"))
...
function switchTab(mode) {
  ...
  document.getElementById("imageToPdfTab").classList.toggle("active", mode === "imageToPdf")
  ...
  document.getElementById("imageToPdfMode").classList.toggle("hidden", mode !== "imageToPdf")
}
